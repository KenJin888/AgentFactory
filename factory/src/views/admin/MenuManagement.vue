                ...
                <td class="px-5 py-4 text-center fixed-col">
                  <div class="flex items-center justify-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                      ...
                      class="p-2 text-slate-800 hover:text-emerald-600 hover:bg-emerald-50 rounded-xl transition-all disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-transparent disabled:hover:text-slate-800"
                      :title="canCreate ? '新增子菜单' : '无权限'"
                    >
...
// 权限配置
const PERMS = {
  query: 'module_system:menu:query',
  create: 'module_system:menu:create',
  update: 'module_system:menu:update',
  delete: 'module_system:menu:delete',
  export: 'module_system:menu:export',
} as const
...
const exportAuth = useCrudAuth({ export: PERMS.export })
...
const canExport = computed(() => exportAuth.can('export'))
