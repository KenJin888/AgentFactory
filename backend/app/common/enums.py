...
class RedisInitKeyConfig(Enum):
    ...
    WECHAT_MP_ACCESS_TOKEN = {"key": "wechat_mp_access_token", "remark": "公众号access_token缓存"}
    WECHAT_MP_LOGIN_SCENE = {"key": "wechat_mp_login_scene", "remark": "公众号扫码scene映射"}
    WECHAT_MP_LOGIN_STATE = {"key": "wechat_mp_login_state", "remark": "公众号扫码登录状态"}
