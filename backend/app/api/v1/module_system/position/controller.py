...
async def get_obj_list_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["module_system:position:query"], check_data_scope=False))],
) -> JSONResponse:
    """
    查询岗位列表
...
async def get_obj_detail_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["module_system:position:detail"], check_data_scope=False))],
) -> JSONResponse:
    """
    查询岗位详情
...
async def create_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["module_system:position:create"], check_data_scope=False))],
) -> JSONResponse:
    """
    创建岗位
...
async def update_obj_controller(
    ...
    id: Annotated[int, Path(description="岗位ID")],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["module_system:position:update"], check_data_scope=False))],
) -> JSONResponse:
    """
    修改岗位
...
async def delete_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["module_system:position:delete"], check_data_scope=False))],
) -> JSONResponse:
    """
    删除岗位
...
async def batch_set_available_obj_controller(
    ...
    auth: Annotated[AuthSchema, Depends(AuthPermission(["module_system:position:patch"], check_data_scope=False))],
) -> JSONResponse:
    """
    批量修改岗位状态
...
async def export_obj_list_controller(
    search: Annotated[PositionQueryParam, Depends()],
    auth: Annotated[AuthSchema, Depends(AuthPermission(["module_system:position:export"], check_data_scope=False))],
) -> StreamingResponse:
    """
    导出岗位
