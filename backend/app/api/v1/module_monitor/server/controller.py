...
@ServerRouter.get('/restart', summary="前后端更新重启", description="前后端更新重启")
async def all_restart_controller():
    os.system('start /D D:\\p2025\\p2025  frontend1.bat')
    await asyncio.sleep(40)
    os.system('start /D D:\\p2025\\p2025  frontend2.bat')
    return SuccessResponse(msg='restarting')
